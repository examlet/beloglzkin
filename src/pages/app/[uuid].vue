        ...
        <n-layout style="width: 100%; height: 100%;">
            <n-modal v-model:show="showModal" class="custom-card" preset="card" :style="{ width: '480px' }"
                ...
                <n-form>
                    ...
                    <n-form-item label="Выберите участников">
                        <n-transfer source-title="Сотрудники" target-title="Выбранные" ref="transfer"
            ...
            <n-modal v-model:show="showModal2" class="custom-card" preset="card" :style="{ width: '940px' }"
                ...
                <n-form>
                    ...
                    <n-data-table style="margin-bottom: 20px;" :columns="columns" :data="data" :pagination="false"
                        :bordered="false" />
                    <p>Изменить этап</p>
                    <n-select :options="options2" />
                </n-form>
            </n-modal>
            <n-modal v-model:show="showModal3" class="custom-card" preset="card" :style="{ width: '1024px' }"
                title="Отчет по клиентам за сегодняшний день" :bordered="false" size="huge" :segmented="true">
                
                <img src="https://sun9-20.userapi.com/impf/Vi57peo2mcVBGpEpPxYUh8XaSJZbW9nf4HTcvw/UbZFT-_DUds.jpg?size=1280x600&quality=96&sign=4c28fe75ab7f1402434d68de8563b60b&type=album" v-if="load" />
            ...
            <n-layout has-sider style="width: 100%; height: 100%;">
                ...
                <n-layout style="padding: 40px; background-color: #edeef0;">
                    ...
                    <n-space style="margin-top: 32px;">
                        <NCard closable title="Сделать" style="width: 240px; height: 580px;">
                            <n-space vertical>
                                ...
                                <n-button v-show="kek">Новая задача</n-button>
                            </n-space>
                        </NCard>
                    ...
                    <n-button @click="keks" type="primary" style="margin-left: 20px; margin-top: 40px;">
                        Сформировать отчет
                    </n-button>
                </n-layout>
            </n-layout>
...
import { NSpin, useDialog, NSelect, NIcon, NLayout, NLayoutFooter, NLayoutSider, NLayoutHeader, NMenu, NSpace, NCard, NButton, NModal, NForm, NFormItem, NInput, NColorPicker, NDatePicker, NTransfer, NStatistic, NTable, DataTableColumns, NDataTable, NDialogProvider } from 'naive-ui'
import {
...
const data: Song[] = [
    ...
    { no: 3, title: 'Сотрудник 4', length: '100%' }
]
